// icons.js
// Ikon SVG inline (gaya garis/outline, satu warna lewat currentColor) --
// SENGAJA tidak pakai icon-font/CDN eksternal (mis. Font Awesome) supaya
// situs statis ini tetap tanpa dependensi tambahan & tetap ringan/cepat.
// Path SVG berikut mengikuti konvensi umum ikon garis 24x24 viewBox.

var ICON_PATHS = {
  home: '<polyline points="9 22 9 12 15 12 15 22"></polyline><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>',
  ...
  messageCircle: '<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8z"></path>'
};

/** Render satu ikon sebagai markup SVG string. class tambahan opsional (mis. 'icon-lg'). */
